          ...
          <div className="w-full xl:max-w-[750px] space-y-3 pr-0 xl:pr-16">
            ...
            >
              <p className="pb-4">
                ...
                contribue à une chevelure plus lisse et plus brillante.
                Protection contre les agressions extérieures: En renforçant la
                barrière capillaire, ce masque protège vos cheveux des dommages
                causés par les éléments et les appareils chauffants.
              </p>
            </div>
            <h4
              className="text-size16 uppercase font-semibold flex justify-between items-center cursor-pointer"
            ...
            >
              <p className="pb-4">
                ...
                Laissez agir pendant 5 à 10 minutes pour permettre aux
                ingrédients de pénétrer. Rincez abondamment à l'eau tiède.
                Utilisez ce masque capillaire une à deux fois par semaine pour
            ...
            >
              <p className="pb-4">
                ...
                spinosa gum, Alcool cétylique (Cetyl Alcohol), Parfum
                (Fragrance), Acide citrique.
              </p>
            </div>
          </div>
